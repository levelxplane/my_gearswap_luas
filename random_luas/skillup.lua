...
user_settings = {
    user_spells = {
        Healing = T{'Cure', 'Cure II', 'Curaga'},
        Geomancy = T{'Indi-Refresh', 'Indi-Regen', 'Indi-STR', 'Indi-VIT', 'Indi-DEX'},
        Enhancing = T{'Protect', 'Shell', 'Regen', 'Blink'},
        Ninjutsu = T{},
        Singing = T{},
        Blue = T{},
        Summoning = T{'Titan', 'Ifrit', 'Garuda'}},
